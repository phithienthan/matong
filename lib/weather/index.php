...
error_reporting(0);
$col = $w = $g = $r = '';
$data = @file_get_contents('http://vnexpress.net/block/crawler?arrKeys%5B%5D=thoi_tiet_full&arrKeys%5B%5D=gia_vang&arrKeys%5B%5D=ty_gia');
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Lấy tỷ giá , giá vàng , thời tiết</title>
        ...
        <style>
            td
            {
                font-size:<?php if (!empty($_GET['fsize']) && $_GET['fsize']) {
    echo $_GET['fsize'] . 'px';
} else {
    echo '12px';
} ?>
            ...
            .bg_tb
            {
                background:url(<?php if (!empty($_GET['bg']) && $_GET['bg']) {
    echo $_GET['bg'];
} else {
    echo 'images/bg.png';
} ?>) #fff;
                background-repeat:<?php if (!empty($_GET['repeat']) && $_GET['repeat']) {
    echo $_GET['repeat'];
} else {
    echo 'repeat-x';
} ?>
...
if (!empty($_GET['col']) && $_GET['col'] == 1) {
    ?>
            ...
            <table width="<?php if ($_GET['size']) {
        echo $_GET['size'] . 'px';
    } else {
        echo '280px';
    } ?>" cellspacing="0" cellpadding="0" border="0" class="bg_tb">
    <?php
    if ($_GET['w'] == 1) {
        ?>
                    <tr>
                        <td  valign="top" style="padding:5px">
                            ...
                            <table width="120px" border="0" cellspacing="0" cellpadding="0">
                                <tr><td><img src="images/cloud.png" border="0"  width="25px" style="vertical-align:middle" alt="Cập nhật thời tiết" /><b>Thời tiết</b></td>
                                </tr>
    ...
    if ($_GET['r'] == 1) {
        ?>
                    <tr>
                        <td style="padding:5px">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td colspan="2">
                                        <img src="images/circle-chart.png" style="vertical-align:middle" border="0" title="Cập nhật thời tiết,tỷ giá,giá vàng từ vnexpress"  alt="Tỷ giá" />
                                        <b>Tỷ giá</b>                              </td>
                                </tr>
                                <tr>
                                    <td colspan="2" width="95%">
                                        <div id="AdTyGiaLoc">
                                            <div class="demo" style="height: 190px;"><table class="bor_ctd" border="0"  cellpadding="0" cellspacing="0" width="95%" bgcolor="#ffffff">
                                                    <?php
            ...
            ?>
                        ...
                        ?>
            <table width="<?php if (!empty($_GET['size']) && $_GET['size']) {
                            echo $_GET['size'] . 'px';
                        } else {
                            echo '280px';
                        } ?>" cellspacing="0" cellpadding="0" border="0" class="bg_tb">
    ...
    ?>
                    ...
                    <td style="padding:5px;padding-left:10px">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr><td colspan="2">
                                        <img title="Cập nhật thời tiết,tỷ giá,giá vàng từ vnexpress"  border="0" src="images/money.png" style="vertical-align:middle" width="25px" alt="Giá vàng" />
                                        <b>Giá vàng</b>
                                    </td></tr>
                                <tr><td>
